...
MUTABLE_KEYS = {
    ...
    "filesystem_enabled", "filesystem_max_file_size", "filesystem_max_read_size", "filesystem_max_write_size", "filesystem_soft_delete",
